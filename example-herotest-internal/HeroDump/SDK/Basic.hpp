...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0754F3D0;
	constexpr int32 AppendString      = 0x023AE440;
	constexpr int32 GNames            = 0x07513080;
	constexpr int32 GWorld            = 0x0769BE90;
	constexpr int32 ProcessEvent      = 0x0259D6E0;
