...
static_assert(alignof(IInstructionInterface_C) == 0x000001, "Wrong alignment on IInstructionInterface_C");
static_assert(sizeof(IInstructionInterface_C) == 0x000001, "Wrong size on IInstructionInterface_C");
