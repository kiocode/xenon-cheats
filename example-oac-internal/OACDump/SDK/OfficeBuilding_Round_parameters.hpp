...
static_assert(offsetof(OfficeBuilding_Round_C_UserConstructionScript, CallFunc_SetStaticMesh_ReturnValue) == 0x0000DC, "Member 'OfficeBuilding_Round_C_UserConstructionScript::CallFunc_SetStaticMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(OfficeBuilding_Round_C_UserConstructionScript, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x0000E0, "Member 'OfficeBuilding_Round_C_UserConstructionScript::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
