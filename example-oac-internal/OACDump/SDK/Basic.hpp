...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04AFBFD0;
	constexpr int32 AppendString      = 0x010CF040;
	constexpr int32 GNames            = 0x04ABFC80;
	constexpr int32 GWorld            = 0x04C444F0;
	constexpr int32 ProcessEvent      = 0x012BF050;
