...
namespace offset {
    constexpr std::ptrdiff_t serverStatic = 0x615760;
    constexpr std::ptrdiff_t clientStatic = 0x5E74D0;
} 
...
{
public:
	char pad_0000[8352]; //0x0000
	int32_t idLocalPlayer; //0x20A0
	int32_t onlinePlayers; //0x20A4
	int32_t onlinePlayers2; //0x20A8
	char pad_20AC[56]; //0x20AC
	class Entity entities[64]; //0x20E4
	char pad_5EE4[256]; //0x5EE4
}; //Size: 0x5FE4
